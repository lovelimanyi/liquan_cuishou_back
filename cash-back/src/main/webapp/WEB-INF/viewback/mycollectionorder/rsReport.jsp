                            ...
                            <div class="col-lg-12">
                                ...
                                <div class="table-box">
                                    ...
                                    <table>
                                        <tr>
                                            <td>姓名</td>
                                            <td>${basicInfo.realName}</td>
                                        </tr>
                                        <tr>
                                            <td>身份证</td>
                                            <td>${basicInfo.idcardNumber}</td>
                                        </tr>
                                        <tr>
                                            <td>手机号</td>
                                ...
                                <div class="table-box">
                                    ...
                                    <table>
                                        ...
                                        <tbody>
                                        <c:forEach items="${callDetail}" var="callDetail">
                                            <tr>
                                                <td>${callDetail.peerNumber }</td>
                                                <td>${callDetail.durationSec }</td>
                                                <td>${callDetail.time }</td>
                                                <td>${callDetail.location }</td>
                                                <td>${callDetail.fee }</td>
                                                <td>${callDetail.dialType }</td>
                                                <td>${callDetail.peerOperator }</td>
                                            </tr>
                                        </c:forEach>
                                        </tbody>
                                    </table>

                            ...
                            <div class="col-lg-12">
                                ...
                                <div class="table-box">
                                    ...
                                    <table>
                                        ...
                                        <tr>
                                            <td>本机可用余额</td>
                                            <td>${basicInfo.available_balance}</td>
                                        </tr>
                                        <tr>
                                            <td>注册该号码所填的地址</td>
                                            <td>${basicInfo.province_city}</td>
                                        </tr>
                                        <tr>
                                            <td>入网时间</td>
                                            <td>${basicInfo.open_time}</td>
                                        </tr>
                                    </table>
                                </div>
                                <div class="table-box">
                                    ...
                                    <table>
                                        ...
                                        <tbody>
                                        <c:forEach items="${call}" var="calls">
                                            <c:forEach items="${calls.call_items}" var="callDetail">
                                                <tr>
                                                    <td>${callDetail.items_peer_number }</td>
                                                    <td>${callDetail.items_duration }秒</td>
                                                    <td>${callDetail.items_time }</td>
                                                    <td>${callDetail.items_location }</td>
                                                    <td>${callDetail.items_fee }</td>
                                                    <c:if test="${callDetail.items_dial_type =='DIAL'}">
                                                        <td>主叫</td>
                                                    </c:if>
                                                    <c:if test="${callDetail.items_dial_type =='DIALED'}">
                                                        <td>被叫</td>
                                                    </c:if>
                                                </tr>
                                            </c:forEach>

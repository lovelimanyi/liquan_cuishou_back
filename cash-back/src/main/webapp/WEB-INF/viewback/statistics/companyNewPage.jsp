...
<form id="pagerForm" onsubmit="return navTabSearch(this);" action="statistics/smallAmountStatistics?Flag=companyNew&myId=${params.myId}">
...
<script type="text/javascript">
    ...
    function reportExcel(obj){
        ...
        var Flag='companyNew';
        var toHref=href+"&createDate="+createDate+"&groupLevel="+groupLevel+"&companyId="+companyId

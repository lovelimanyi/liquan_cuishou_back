...
public class MmanLoanCollectionOrder {
    ...
    // m6+审批人操作状态（1，已操作过，0或null未操作过）
    private String m6OperateStatus;
    // 催收状态
    ...
    public String getM6OperateStatus() {
        return this.m5OperateStatus;
    }

    public void setM6OperateStatus(String m6OperateStatus) {
        this.m6OperateStatus = m6OperateStatus;
    }
